 ...
 * const authority2 = getAuthority( 'https://workathome.communication-coach.com:8080/test/' ); // 'localhost:8080'
 * ```
 *
 ...
 * @example
 * ```js
 * const path1 = getPath( 'http://workathome.communication-coach.com:8080/this/is/a/test?query=true' ); // 'this/is/a/test'
 ...
 * @example
 * ```js
 * const queryString = getQueryString( 'http://workathome.communication-coach.com:8080/this/is/a/test?query=true#fragment' ); // 'query=true'
 * ```
 *
 ...
 * @example
 * ```js
 * const pathAndQueryString1 = getPathAndQueryString( 'http://workathome.communication-coach.com:8080/this/is/a/test?query=true' ); // '/this/is/a/test?query=true'
 ...
 * @example
 * ```js
 * const fragment1 = getFragment( 'http://workathome.communication-coach.com:8080/this/is/a/test?query=true#fragment' ); // '#fragment'
